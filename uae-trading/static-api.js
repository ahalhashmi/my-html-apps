  ...
  function toCsv(profiles) {
    ...
    const rows = profiles.map((profile) => {
      ...
      return [
        ...
        decision.action,
        decision.setup_type,
        decision.setup_grade,
        decision.liquidity_tier || consideration.liquidity_tier,
        decision.regime || consideration.regime,
        decision.location || consideration.location,
        decision.zone_score ?? consideration.zone_score,
        decision.location_score ?? consideration.location_score,
        decision.confluence_score ?? consideration.confluence_score,
        decision.demand_zone_low ?? consideration.demand_zone_low,
        decision.demand_zone_high ?? consideration.demand_zone_high,
        decision.supply_zone_low ?? consideration.supply_zone_low,
        decision.supply_zone_high ?? consideration.supply_zone_high,
        ...
        consideration.regime_score,
        consideration.demand_zone_score,
        consideration.supply_zone_score,
        indicators.rsi14,
